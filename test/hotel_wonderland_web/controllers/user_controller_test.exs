defmodule HotelWonderlandWeb.UserControllerTest do
  use HotelWonderlandWeb.ConnCase

  alias HotelWonderland.Accounts

  @create_attrs %{email: "some email", full_name: "some full_name", password_hash: "some password_hash", phone_number: "some phone_number"}
