defmodule HotelWonderlandWeb.RoomControllerTest do
  use HotelWonderlandWeb.ConnCase

  alias HotelWonderland.Accounts

  @create_attrs %{available: true, description: "some description", number_of_persons: 42, price: 42, type: "some type"}
